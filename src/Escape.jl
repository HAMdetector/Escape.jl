...
include("combined_normal_pooled.jl")
include("combined_normal_unpooled.jl")
include("combined_hs_unpooled.jl")
include("combined_hs_pooled.jl")
include("normal_phylogeny_pooled.jl")
