...
no overfitting but improvements show for different data sets and different viruses
...
if quality is the same for all viruses: differences between immune/virus interactions become visible

recombinant forms

4-digit partial pooling
