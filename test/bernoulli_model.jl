...
@testset "stan_input(::BernoulliModel, ::Replacement, ::HLData)"  begin
    ...
    input = Escape.stan_input(BernoulliModel(), replacement, hla_data)
...
@testset "run(::BernoulliModel, ::Replacement, ::HLAData)" begin
    ...
    @test @suppress Escape.run(BernoulliModel(), replacement, hla_data) isa BernoulliResult
end